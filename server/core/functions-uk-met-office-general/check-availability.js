...
module.exports = files => new Promise((resolve, reject) => {
  log("Checking whether new .grib2 files are available for downloading", "METOFFICEGENERAL_CHECKAVAILABILITY");
  axios({
    ...
    if (availability.indexOf(null) > -1) {
      ...
      log("New files are available for downloading", "METOFFICEGENERAL_CHECKAVAILABILITY");
